...
ALL_CFLAGS = -mcpu=$(MCU) $(CFLAGS) $(GENDEPFLAGS) $(EXTRAFLAGS)
ALL_CPPFLAGS = -mcpu=$(MCU) -x c++ $(CPPFLAGS) $(GENDEPFLAGS) $(EXTRAFLAGS)
ALL_ASFLAGS = -mcpu=$(MCU) -x assembler-with-cpp $(ASFLAGS) $(EXTRAFLAGS)
...
teensy: $(TARGET).hex
	teensy_loader_cli -mcpu=$(MCU) -w -v $(TARGET).hex
